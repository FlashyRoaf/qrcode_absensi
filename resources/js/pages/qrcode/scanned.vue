<template>
  ...
  <div
    class="min-h-screen bg-zinc-950 text-zinc-100 font-sans overflow-x-hidden relative flex items-center justify-center">
    ...
    <div class="fixed top-0 left-1/2 -translate-x-1/2 w-[600px] h-[300px] z-0 pointer-events-none" :style="success
      ...
      <div class="grid grid-cols-1 lg:grid-cols-2 gap-8 items-center">
        ...
        <div class="flex flex-col gap-5">
          ...
          <div class="bg-zinc-900 border rounded-2xl p-8 flex flex-col items-center gap-6 relative overflow-hidden"
            ...
            <div class="absolute inset-0 pointer-events-none rounded-2xl" :style="!success
            ...
            <div class="relative flex items-center justify-center">
              ...
              <!-- Core -->
              <div class="w-16 h-16 rounded-full flex items-center justify-center relative z-10 border" :class="{
            ...
            <!-- Status indicator -->
            <div class="w-full bg-zinc-800/60 border rounded-xl px-4 py-3 flex items-center gap-3" :class="{
              ...
              <div class="flex-1 min-w-0">
                ...
                <p class="text-sm font-semibold truncate" :class="success ? 'text-emerald-400' : 'text-red-400'">
        ...
        <div class="flex flex-col gap-5">
          ...
          <!-- Title -->
          <div>
            <h2 class="text-2xl font-bold" :class="success ? 'text-zinc-100' : 'text-red-400'">
              {{ success
          ...
          <div v-if="props.message" class="border rounded-2xl p-6 flex flex-col gap-4" :class="{
            ...
            <div class="h-px w-full" :style="success
            ...
            <div class="space-y-3">
              ...
              <div class="flex items-center justify-between py-2">
                ...
                <span class="text-xs font-mono flex items-center gap-1.5"
                  :class="success ? 'text-emerald-400' : 'text-red-400'">
                  <span class="w-1.5 h-1.5 rounded-full" :class="success ? 'bg-emerald-400' : 'bg-red-400'"></span>
          ...
          <div class="bg-zinc-900 border border-zinc-800 rounded-2xl p-5 space-y-4">
            ...
            <div class="space-y-3">
              <div v-for="(step, i) in nextSteps" :key="i" class="flex items-start gap-3">
                <div
                  class="w-5 h-5 rounded-full bg-zinc-800 border border-zinc-700 flex items-center justify-center text-xs text-zinc-500 flex-shrink-0 mt-0.5">
                  {{ i + 1 }}
                </div>
    ...
    <main v-else>
      <div class="relative z-10 min-h-screen flex items-center justify-center bg-black text-white">

        <div class="bg-zinc-900 px-8 py-10 rounded-2xl shadow-lg text-center w-full max-w-sm">
...
onMounted(async () => {
  try {
        ...
        // Kalau gagal ambil lokasi, tetap lanjut — validasi di backend
        form.latitude  = null
        form.longitude = null
    }
